...
export const EXERCISE_LIBRARY: Exercise[] = [
  ...
  { key: 'dumbbell_incline_press', name: 'Dumbbell Incline Press', met: 4.5, muscle: 'Chest', equipment: 'Dumbbell' },
  { key: 'dumbbell_decline_press', name: 'Dumbbell Decline Press', met: 4.5, muscle: 'Chest', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_deadlift', name: 'Dumbbell Deadlift', met: 5.0, muscle: 'Back', equipment: 'Dumbbell' },
  { key: 'dumbbell_pullover', name: 'Dumbbell Pullover', met: 3.5, muscle: 'Back', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_upright_row', name: 'Dumbbell Upright Row', met: 4.5, muscle: 'Shoulders', equipment: 'Dumbbell' },
  { key: 'dumbbell_scott_press', name: 'Dumbbell Scott Press', met: 4.5, muscle: 'Shoulders', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_skull_crusher', name: 'Dumbbell Skull Crusher', met: 3.5, muscle: 'Arms', equipment: 'Dumbbell' },
  { key: 'dumbbell_incline_curl', name: 'Dumbbell Incline Curl', met: 3.5, muscle: 'Arms', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_step_up', name: 'Dumbbell Step-Up', met: 4.5, muscle: 'Legs', equipment: 'Dumbbell' },
  { key: 'dumbbell_romanian_deadlift', name: 'Dumbbell Romanian Deadlift', met: 5.0, muscle: 'Legs', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_side_bend', name: 'Dumbbell Side Bend', met: 3.0, muscle: 'Abs', equipment: 'Dumbbell' },
  { key: 'mountain_climber', name: 'Mountain Climber', met: 8.0, muscle: 'Abs', equipment: 'Bodyweight' },
  ...
  { key: 'dumbbell_sumo_deadlift', name: 'Dumbbell Sumo Deadlift', met: 5.0, muscle: 'Glutes', equipment: 'Dumbbell' },
  { key: 'dumbbell_kickback', name: 'Dumbbell Standing Kickback', met: 3.0, muscle: 'Glutes', equipment: 'Dumbbell' },
  ...
  { key: 'dumbbell_squat', name: 'Dumbbell Squat', met: 5.0, muscle: 'Full Body', equipment: 'Dumbbell' },
  { key: 'dumbbell_burpee', name: 'Dumbbell Burpee', met: 8.0, muscle: 'Full Body', equipment: 'Dumbbell' },
];
...
export const WORKOUT_CATEGORIES: WorkoutCategory[] = [
  {
    ...
    exerciseKeys: ['squat', 'bench_press', 'bent_over_row', 'shoulder_press', 'bicep_curl', 'tricep_pushdown', 'deadlift', 'kettlebell_swings', 'burpees', 'clean_and_press', 'thrusters', 'dumbbell_squat', 'dumbbell_burpee'],
  },
  {
    key: 'chest',
    name: 'Chest Workout',
    icon: 'arm-flex',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['bench_press', 'incline_bench_press', 'dumbbell_chest_press', 'chest_fly', 'push_up', 'cable_crossover', 'decline_bench_press', 'dumbbell_incline_press', 'dumbbell_decline_press'],
  },
  {
    key: 'back',
    name: 'Back Workout',
    icon: 'weight',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['deadlift', 'bent_over_row', 'lat_pulldown', 'seated_row', 'pull_up', 't_bar_row', 'single_arm_row', 'dumbbell_deadlift', 'dumbbell_pullover'],
  },
  {
    key: 'arms',
    name: 'Arm Workout',
    ...
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['bicep_curl', 'hammer_curl', 'concentration_curl', 'preacher_curl', 'tricep_pushdown', 'overhead_tricep_extension', 'skull_crusher', 'dips', 'close_grip_bench', 'dumbbell_skull_crusher', 'dumbbell_incline_curl'],
  },
  {
    key: 'shoulders',
    ...
    icon: 'weight-lifter',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['shoulder_press', 'lateral_raise', 'front_raise', 'upright_row', 'face_pull', 'reverse_fly', 'arnold_press', 'dumbbell_upright_row', 'dumbbell_scott_press'],
  },
  {
    key: 'lower_body',
    ...
    icon: 'run',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['squat', 'leg_press', 'leg_curl', 'leg_extension', 'lunges', 'romanian_deadlift', 'bulgarian_split_squat', 'calf_raise', 'seated_calf_raise', 'dumbbell_step_up', 'dumbbell_romanian_deadlift'],
  },
  {
    key: 'upper_body',
  ...
  },
  {
    ...
    icon: 'target',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['crunches', 'plank', 'russian_twist', 'hanging_leg_raise', 'cable_crunch', 'ab_wheel', 'dumbbell_side_bend', 'mountain_climber'],
  },
  {
    key: 'v_taper',
  ...
  },
  {
    ...
    icon: 'run-fast',
    iconLib: 'MaterialCommunityIcons',
    exerciseKeys: ['hip_thrust', 'glute_bridge', 'sumo_squat', 'bulgarian_split_squat', 'romanian_deadlift', 'cable_kickback', 'lunges', 'dumbbell_sumo_deadlift', 'dumbbell_kickback'],
  },
];
